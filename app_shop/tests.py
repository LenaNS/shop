...
class ProductViewSetTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.price = Price.objects.create(currency="USD", amount=100.00)
...
class PriceViewSetTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.price = Price.objects.create(currency="USD", amount=100.57)
        self.price2 = Price.objects.create(currency="RUB", amount=1000.00)
...
class CategoryViewSetTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.category = Category.objects.create(name="Test Category1", description="A category for testing1")
        self.category2 = Category.objects.create(name="Test Category2", description="A category for testing2")
    ...
    def test_create_category(self):
        ...
        data = {
            "name": "Test Category3",
            "description": "A category for testing3"
        }
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_update_category(self):
        ...
        data = {
            ...
            "description": "A category for testing2"
        }
        response = self.client.put(url, data, format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
